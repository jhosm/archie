...
| [003](./ADR-IC-003-saga-orchestrator.md) | Saga Orchestrator | **Event-driven application orchestrator** (in-house; no third-party orchestration engine). Amended 2026-05-22: in-process saga libraries (e.g. Wolverine `Saga`, Commanded process managers) permitted — the rejection targets external workflow services, not in-process libraries co-located with domain code | [05](../05-constitution-saga-walkthrough.md) |
