...
- [ADR-PC-004 §A1](../../product_concepts/adrs/ADR-PC-004-pii-crypto-shredding.md) — the OpenBao secret boundary the AS's signing keys resolve through (never on the bus).
