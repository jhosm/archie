...
| [feature-design-c4-architecture](./feature-design-c4-architecture.md) | `c4` | A C4 model (System Context / Container / Component, rendered as PlantUML) of the engine described in [01](./01-product-architecture.md) — a view onto decisions already made, not a new decision: every box and line traces to a concept doc, feature-design note, or ADR. Cited by [ADR-IC-013](../integration_concepts/adrs/ADR-IC-013-in-house-estate-build-and-repository-placement.md). |
