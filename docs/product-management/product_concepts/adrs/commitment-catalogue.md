...
enumerated estate and stay authoritative there (their governing-source cells now
also cite ADR-PC-040 as the shared covenant they instantiate); XC-1/XC-2 guard the
