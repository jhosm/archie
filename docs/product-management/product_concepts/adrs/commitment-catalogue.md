...
`INTEGRATION_EVENT_CATALOG_GATED` (row 21) and `NO_UNCATALOGUED_EVENT_ON_BUS` (row 22) land
with the catalog-gated-relay implementing issue (ADR-IC-017 §P1/§P3). Rows 21–22 are the first **in-house ADR-IC**
