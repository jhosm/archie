...
> short-forms `[ADR-PC-NNN]` link to [`./adrs/`](./adrs/README.md); design-note short-forms
...
architecture is **decided**: ADR-PC-000…020 (product engine, [`./adrs/`](./adrs/README.md)) and
ADR-IC-000…013 (integration estate,
[`../integration_concepts/adrs/`](../integration_concepts/adrs/README.md)) are all Accepted, and the
