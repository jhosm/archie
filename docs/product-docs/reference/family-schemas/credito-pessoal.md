<!-- DO NOT EDIT — generated by scripts/docs-gen/generate.py from contracts/cue/families/credito-pessoal.cue. Run: make docs-gen -->

# Family schema — `credito-pessoal`

The closed CUE contract a `credito-pessoal` variant YAML must satisfy (no DSL escape hatch — a field the schema does not declare is rejected). Canonical, fully-resolved form via `cue def`; the authored source is `contracts/cue/families/credito-pessoal.cue`.
