...
| [04](./04-open-questions.md) | Open Questions | Deferred decisions with context and unblocking notes — competitive positioning, pricing, licensing, coexistence targets, multi-tenancy, IFRS 9 signal boundary, time-travel, configurability depth |
