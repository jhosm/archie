...
/// <c>Babelstone.EventStore.Migrations</c>). Once applied, a migration is immutable: its
/// <see cref="Sql"/> is never edited, only superseded by a higher-<see cref="Version"/>
/// migration.
/// </summary>
...
/// <param name="Name">Human label after the version prefix (e.g. <c>saga_state</c>).</param>
