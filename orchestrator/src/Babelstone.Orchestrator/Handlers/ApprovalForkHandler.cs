...
namespace Babelstone.Orchestrator.Handlers;
...
public static class ApprovalForkHandler
{
    ...
    /// at <see cref="SagaState.ValidationsComplete"/> — every reversible precondition has
    ...
    public static ApprovalDecision Decide(SagaState current, ApprovalDecisionInput input)
    {
        if (current != SagaState.ValidationsComplete)
        {
