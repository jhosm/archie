...
/// (ADR-IC-011 §P3 — "the notification service uses its own PostgreSQL table for the delivery store";
/// the discipline lifted from the engine's <c>Babelstone.EventStore.Migrations</c> via the
/// orchestrator's and the lifecycle driver's copies, ADR-PC-001 §P5). Once applied, a migration is
