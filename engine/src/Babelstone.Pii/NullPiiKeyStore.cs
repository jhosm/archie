...
/// field is annotated/encrypted yet (the <c>NullPiiProtector</c> posture, ADR-PC-004, Epic C
...
///
/// <para>It exists so the GDPR right-to-be-forgotten flow is wired and exercisable
...
public sealed class NullPiiKeyStore : IPiiKeyStore
{
    ...
    /// <summary>
    /// Crypto-shred no-op: with no real key there is nothing to destroy (ADR-PC-004). Idempotent by
