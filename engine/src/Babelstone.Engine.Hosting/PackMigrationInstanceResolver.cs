...
/// name, no PII (ADR-PC-004) ever reaches the spine.
/// </summary>
...
/// </summary>
/// <remarks>
/// The spine names no family (ADR-PC-021): a family supplies the implementation over its read model
...
public interface IPackMigrationInstanceResolver
{
    ...
    /// The migration write-path narrows this to the subset still on <c>from_pack_version</c> via the
