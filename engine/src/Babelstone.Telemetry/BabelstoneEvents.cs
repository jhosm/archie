...
///
/// As with span attributes, a log emitted under these ids carries only ADR-IC-007 §P4
...
public static class BabelstoneEvents
{
    ...
    /// family's <c>effective_from</c> (ADR-PC-008 §P5 forward-only immutability). Logged with the
