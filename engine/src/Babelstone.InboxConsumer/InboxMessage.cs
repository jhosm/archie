...
/// it un-frames the Confluent wire-format value, decodes the Avro via the codec, and reads the
...
/// not personal data — ADR-PC-004): <see cref="MessageId"/> and <see cref="AggregateId"/> are
