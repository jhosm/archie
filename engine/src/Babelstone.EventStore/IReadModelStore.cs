...
/// (ADR-PC-021 §D2/§P2). A new family materialises its read model by supplying its row type + a
...
{
    /// <summary>
    /// The ADR-IC-005 §P2 canonical write: UPSERT the row by <see cref="IReadModelRow.StreamId"/>,
