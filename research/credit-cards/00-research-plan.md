...
> **Status:** Plan (draft). Pure market research — **not** babelstone product work yet.
> No engine/ADR/contract concerns in scope. This folder (`research/credit-cards/`) is a
> scratch deliverable; nothing here is committed to a babelstone doc series unless we
> later decide to promote it.
