    ...
    SettlementTarget settlementTarget = SettlementTarget.LegacyDda)
{
    ...
    // (ADR-PC-043). In plain English: when a deposit matures, pays a coupon, terminates early, or
    ...
    public async Task<long> MatureAsync(MatureDepositCommand command, CancellationToken ct = default)
    {
        ...
        // Thread the counterparty selector (ADR-PC-043): the persistent payout account already rides
    ...
    public async Task<long> PayInterestAsync(PayInterestCommand command, CancellationToken ct = default)
    {
        ...
        // Thread the counterparty selector (ADR-PC-043): the persistent payout account rides
    ...
    public async Task<long> ConstituteRenewalAsync(ConstituteRenewalCommand command, CancellationToken ct = default)
    {
        ...
        // Thread the counterparty selector onto both renewal legs (ADR-PC-043): the persistent funding
