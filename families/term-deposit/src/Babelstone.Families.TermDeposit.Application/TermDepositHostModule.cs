...
public sealed class TermDepositHostModule : IFamilyHostModule
{
    ...
    public void ConfigureServices(IServiceCollection services, FamilyHostContext ctx)
    {
        ...
        // The term-deposit decider (ADR-PC-021): this module is its composition root (§D4). It has no eager
        // settlement dependency — every money-moving leg is de-settled onto the substrate-owned settlement
        // saga via Movement-bearing events (bd babelstone-t7o3.13, ADR-PC-032 slot 5; the old eager
        // settlement port was deleted in bd babelstone-t7o3.17).
