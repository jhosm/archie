...
/// <summary>The lifecycle states the credito_pessoal aggregate folds into. The transition LEGALITY
...
/// <summary>
/// The loan-position projection: the credito_pessoal aggregate's folded state — the closed-end-asset
