...
/// <summary>
/// The pure decision core of the credito_pessoal decider (ADR-PC-021 §P3): given a command plus the
...
/// impure orchestration (resolve, settle, append) lives in <see cref="CreditoPessoalConstitutionService"/>;
...
/// </remarks>
public static class CreditoPessoalDecider
{
    ...
    /// than one year of term remains: 0.50% of the capital repaid (research/credito-pessoal/02 §2; PT DL
    ...
    /// YEAR OR LESS of term remains: 0.25% of the capital repaid (research/credito-pessoal/02 §2).</summary>
        ...
        LoanPosition position, Money repaymentAmount, DateOnly repaidOn, int remainingInstallments)
    {
        ...
        // 0.50%; ≤1 year caps at 0.25% (research/credito-pessoal/02 §2).
