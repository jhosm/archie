...
/// <summary>
/// Replay/fold tests for the credito_pessoal loan position: the pure folds LABEL state and accumulate the
...
{
    private static readonly HandlerRegistry Registry = CreditoPessoalFamilyModule.Registry();
