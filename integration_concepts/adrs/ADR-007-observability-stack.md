...
| SigNoz | Apache 2.0 (core); commercial tier available | Core platform is Apache 2.0; enterprise features are commercial. Self-hosted on ClickHouse. | **Pass** (note: verify required features fall within the Apache 2.0 tier at implementation time) |
