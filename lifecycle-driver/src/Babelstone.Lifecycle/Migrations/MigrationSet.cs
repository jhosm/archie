...
/// <summary>
/// The ordered set of forward-only migrations embedded in this assembly — the lifecycle-driver host's OWN
/// migration series (ADR-PC-038 §Decision 1; lifted from the engine's
/// <c>Babelstone.EventStore.Migrations.MigrationSet</c> via the orchestrator's copy). Discovery is from
/// embedded <c>Migrations/Sql/NNNN_name.sql</c> resources so a deployed binary carries its own schema —
/// there is no loose-file lookup at runtime.
/// </summary>
